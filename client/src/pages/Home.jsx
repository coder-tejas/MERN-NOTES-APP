...
useEffect(()=>{
  if (currentUser === null || !currentUser) {
   ...
   const getAllNotes = async () =>{
    try{
               const res = await axios.get("http://localhost:8080/api/note/all",{withCredentials:true})
...
const handleDelete = async (data)  =>{
      ...
      try{
         const res = await axios.delete(`http://localhost:8080/api/note/delete/${noteId}`,{withCredentials:true})
